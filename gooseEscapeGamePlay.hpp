...
const int MONSTER2X_START = 30;
const int MONSTER2Y_START = 10;

//these are the coordinates of the powerups
const int UPSPEEDX_START = 60;
const int UPSPEEDY_START = 8;
...
//display powerups
const int UPSPEED_CHAR = int('P');

//constants for Actor class
const int SPEED1 = 0;
const int SPEED2 = 2;
