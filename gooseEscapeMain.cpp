...
int main()
{
	...
	//make the powerups
	Actor speedPOWUP(UPSPEED_CHAR, UPSPEEDX_START, UPSPEEDY_START);
	...
	{	
        ...
        if (keyEntered != TK_ESCAPE && keyEntered != TK_CLOSE)
        {
			...
			{
				Actor monster2(MONSTER_CHAR, MONSTER2X_START, MONSTER2Y_START);
				chasingPerson(player, monster2, gameBoard);
			}
        }
  	}
